...
from pyket.optimizers import ComplexValueParametersStochasticReconfiguration
...
model.fit_generator(monte_carlo_generator(), steps_per_epoch=steps_per_epoch, epochs=10, callbacks=callbacks,
