...
tensorboard = TensorBoardWithGeneratorValidationData(log_dir='tensorboard_logs/monte_carlo_batch_%s_run_2' % batch_size, generator=generator, update_freq=1, histogram_freq=1, 
