...
from pyket.callbacks.monte_carlo import TensorBoardWithGeneratorValidationData, MCMCStats, default_wave_function_stats_callbacks_factory
...
tensorboard = TensorBoardWithGeneratorValidationData(log_dir='tensorboard_logs/run_0', generator=generator, update_freq=1, histogram_freq=1, 
...
callbacks = default_wave_function_stats_callbacks_factory(generator, 
	true_ground_state_energy=-50.18662388277671) + [MCMCStats(generator), checkpoint, tensorboard, early_stopping, TerminateOnNaN()]
