...
@pytest.mark.parametrize('layer, input_layer, batch_size', [
    ...
    (Conv2D(8, kernel_size=3, data_format='channels_last'), Input((6, 6, 5)), 1),
    (Conv2D(8, kernel_size=3, data_format='channels_last'), Input((6, 6, 1)), 32),
    (Conv2D(8, kernel_size=3, data_format='channels_last'), Input((6, 6, 5)), 32),
    (Conv2D(8, kernel_size=3, activation='relu', data_format='channels_last'), Input((6, 6, 5)), 32),
    (Conv2D(8, kernel_size=3, data_format='channels_last'), Input((7, 7, 5)), 32),
    (Conv2D(8, kernel_size=3, dilation_rate=2, data_format='channels_last'), Input((10, 10, 5)), 32),
    (Conv2D(8, kernel_size=3, strides=2, data_format='channels_last'), Input((10, 10, 5)), 32),
    ...
    (Conv1D(8, kernel_size=3, data_format='channels_last'), Input((6, 5)), 32),
    (ZeroPadding1D(padding=(1, 0)), Input((6, 5)), 32),
    (ZeroPadding1D(padding=(1, 1)), Input((6, 5)), 32),
    (ZeroPadding1D(padding=(1, 1)), Input((6, 5)), 32),
    (Conv3D(8, kernel_size=(3, 3, 3), data_format='channels_last'), Input((6, 6, 6, 5)), 32),
